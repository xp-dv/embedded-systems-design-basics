...
/* Definitions for print_button */
osThreadId_t print_buttonHandle;
const osThreadAttr_t print_button_attributes = {
  .name = "print_button",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_start_blink_1 */
/**
...
void start_blink_1(void *argument)
{
  ...
  /* USER CODE END start_blink_1 */
}

/* USER CODE BEGIN Header_start_blink_2 */
/**
...
void start_blink_2(void *argument)
{
  ...
  /* USER CODE END start_blink_2 */
}

/* USER CODE BEGIN Header_start_print_button */
/**
* @brief Function implementing the print_button thread.
* @param argument: Not used
* @retval None
*/
...
void start_print_button(void *argument)
{
  ...
  /* USER CODE END start_print_button */
}
